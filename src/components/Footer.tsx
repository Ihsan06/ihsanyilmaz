      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          <div>
            ...
            <a
              href="https://www.instagram.com/aiy.web/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram-Profil von AIY"
              className="inline-flex items-center gap-2 mt-3 ml-5 text-sm text-[var(--fg-muted)] hover:text-[var(--fg)] transition-colors"
            >
