...
const projects = [
  {
    ...
    description: "Fahrzeuge, Anfragen und Werkstatt-Termine auf einer Seite.",
  ...
  },
  {
    ...
    description: "Speisekarte, Öffnungszeiten und Kontakt — klar aufgebaut.",
  ...
  },
  {
    ...
    description: "Fahrzeug wählen, Zeitraum festlegen, anfragen — Verfügbarkeit live.",
