      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        ...
        <div className="space-y-8 text-slate-300 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>E-Mail: <a href="mailto:ihsan.yilmaz@gmx.de" className="text-indigo-400 hover:text-indigo-300">ihsan.yilmaz@gmx.de</a></p>
          </section>

          <section>
            <h2 className="text-white font-semibold text-base mb-3">Steuerliche Angaben</h2>
            <p>Steuernummer: 257/291/52520</p>
            <p className="mt-1 text-slate-500 text-xs">Finanzamt zuständig</p>
          </section>

          <section>
            <h2 className="text-white font-semibold text-base mb-3">Berufsbezeichnung</h2>
            <p>Webentwickler (freiberuflich tätig)</p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-white font-medium mt-4 mb-2">Haftung für Links</h3>
        ...
        <div className="mt-12">
          <a href="/" className="text-indigo-400 hover:text-indigo-300 text-sm transition-colors">← Zurück zur Startseite</a>
        </div>
      </div>
    </main>
  );
